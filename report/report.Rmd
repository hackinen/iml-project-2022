...
The contents of the report are as follows. First, we discuss the methods we used to choose the classification model, what kind of feature selection was done and explain the concept of linear regression briefly. Secondly, we analyze the results of our classifier. Then, we discuss the results and what could be done to improve the results. Lastly, we conclude the analysis.
...
Our data analysis was mainly done by physically looking at the data through Excel. Our understanding of the data, as well as the chosen linear regression model, relied also on our previous knowledge of it throughout the exercise sets of the Introduction to Machine Learning course. 

<!-- joku plottti datasta vaikka ekalta viikolta -->

<!-- standard deviationit ehkä pois jos paremmat tulokset???? -->
...
<!-- choise of model parameters (lasso ridge ja niiden arvot glmnet-funktiossa, miten vaikuttaa) -->
